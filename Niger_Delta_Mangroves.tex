...
\makebox[0.90\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
}\caption{Landsat 8-9 OLI/TIRS images of Niger Delta in natural colour RGB values for six years: (\textbf{a}) 2013/12/20, (\textbf{b}) 2015/12/26, (\textbf{c}) 2021/12/18, (\textbf{d}) 2022/12/29}\label{fig:03}
\end{figure}
...
The NDVI is based on the formula applied since 1979 \cite{TUCKER1979237,RONDEAUX199695,DATT1998111}:
\begin{equation}
...
The use of PVI is based on the ratio between the NIR and Red channels \cite{Naji2018}:
\begin{equation}
	DVI = (NIR - Red)
\end{equation}
...
\makebox[0.90\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
}\caption{ARVI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for six years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_NDVI_2013}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_NDVI_2015}
		\caption{2015}
	\end{subfigure}%
}\\
\vfill \vspace{1mm}
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_NDVI_2021}
		\caption{2021}
	\end{subfigure}
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_NDVI_2022}
		\caption{2022}
	\end{subfigure}%
}\caption{NDVI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for six years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
...
\makebox[0.90\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
}\caption{DVI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for six years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
...
\makebox[0.90\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
}\caption{GARI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for six years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
...
\makebox[0.90\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
}\caption{GVI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for six years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
