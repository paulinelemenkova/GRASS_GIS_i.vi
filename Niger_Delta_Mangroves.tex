...
\abstract{
This paper addresses the image classification issue for mapping vegetation indices in mangrove forests of Niger Delta, Gulf of Guinea using scripting techniques of GRASS GIS. In the last decade, programming approaches were developed and integrated in geospatial studies. This paper proposes a GRASS GIS framework to calculate and visualise ten vegetation indices (VI) using image processing methods by \emph{i.vi}, \emph{i.landsat.toar} and other modules of GRASS GIS. The estuary of the Niger Delta in southern Nigeria is an essential hotspot of biodiversity in western coast of Africa. At the same time, recent issues of changing climate and the effects from the increasing population contribute to the vulnerability of coastal landscapes and present threats to ecosystem communities in southern Nigeria. In this paper, we prove that environmental changes in the coastal landscapes can be numerically modelled and evaluated using a time series analysis of the remote sensing data. We examined four Landsat 8-9 OLI/TIRS images covering the western segment of the Niger Delta in the Bight of Benin for years 2013, 2015, 2021 and 2022. The analysis of data showed variations in the vegetation health of the swamp forests of the Niger Delta over a decade. Variations in spectral reflectance also pointed at changes in urban spaces of the major cities (Onitsha, Sapele, Warri and Benin CIty) and smaller villages in the Delta State caused by recent urbanisation processes. Based on GRASS GIS \emph{i.vi} module, ten VI approaches are applied and mapped for the western segment of the Niger Delta estuary. The results include ten VI computed and visualised using GRASS GIS scripts: Atmospherically Resistant Vegetation Index (ARVI), Green Atmospherically Resistant Vegetation Index (GARI), Green Vegetation Index (GVI), Difference Vegetation Index (DVI), Perpendicular Vegetation Index (PVI), Global Environmental Monitoring Index (GEMI), Normalized Difference Water Index (NDWI), Second Modified Soil Adjusted Vegetation Index (MSAVI2), Infrared Percentage Vegetation Index (IPVI) and Enhanced Vegetation Index (EVI). Experimental results show changes in the vegetation health, plant  greenness and coverage based on the image analysis performed using GRASS GIS. Finally, the technical functionality of the GRASS GIS demonstrated the best performance in terms of image processing and analysis.
}
...
Remote sensing technologies and satellite imagery provide a valuable combination for evaluating area of mangrove distribution threatened to extinction, as well as monitoring the magnitudes of degrading \cite{Hu}. Using several satellite images as a time series helps to estimate the  extent to which coastal ecosystems and mangrove communities is declining through visualization and comparison of scenes taken for several consecutive years. Such time series of satellite images enable to perform change detection in land cover types through comparative analysis of vegetation indices, such as NDVI \cite{OCHEGE2017211,Lemenkova202229}. Previous studies  \cite{NUMBERE2022433,FASHAE2022e01286,Olorunfemi} developed and applied methods based on using remote sensing data and Geographic Information System (GIS) to quantitatively evaluate and map environmental degradation of land cover types and decline of vegetation. 
...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Fig_02c.jpg}
		\caption{2021}
	\end{subfigure}
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Fig_02d.jpg}
		\caption{2022}
	\end{subfigure}%
