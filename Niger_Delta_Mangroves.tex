...
Mangroves have a high environmental and socioeconomic value providing diverse important functions as habitat for species living in intertidal environment \cite{James}. At the same time, recently mangrove ecosystems became under the threat of extinction with the increasing rate of deforestation reported in many relevant papers \cite{Enaruvbe2016,Numbere,Osuji,Fasona}. The deforestation of mangrove forests has diverse reasons. These include both the effects from climate change since the Niger Delta is the most climate-vulnerable region in Nigeria \cite{BALOGUN2022100304,hydrology7010019}, and the anthropogenic activities. The latter ones include, for instance, road construction, housing and farming, or industrial works related to oil such as clearing waterfront vegetation \cite{Zabbey}.

Remote sensing technologies and satellite imagery provide a valuable combination for evaluating area of mangrove distribution, as well as monitoring the magnitudes of degrading \cite{Hu}. 
