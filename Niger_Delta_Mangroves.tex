...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_GEMI_2013}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_GEMI_2015}
		\caption{2015}
	\end{subfigure}%
}\\
\vfill \vspace{1mm}
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_GEMI_2021}
		\caption{2021}
	\end{subfigure}
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_GEMI_2022}
		\caption{2022}
	\end{subfigure}%
}\caption{GEMI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_NDWI_2013}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_NDWI_2015}
		\caption{2015}
	\end{subfigure}%
}\\
\vfill \vspace{1mm}
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_NDWI_2021}
		\caption{2021}
	\end{subfigure}
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_NDWI_2022}
		\caption{2022}
	\end{subfigure}%
}\caption{NDWI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_MSAVI2_2013}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_MSAVI2_2015}
		\caption{2015}
	\end{subfigure}%
}\\
\vfill \vspace{1mm}
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_MSAVI2_2021}
		\caption{2021}
	\end{subfigure}
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_MSAVI2_2022}
		\caption{2022}
	\end{subfigure}%
}\caption{MSAVI2 computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_IPVI_2013}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_IPVI_2015}
		\caption{2015}
	\end{subfigure}%
}\\
\vfill \vspace{1mm}
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_IPVI_2021}
		\caption{2021}
	\end{subfigure}
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_IPVI_2022}
		\caption{2022}
	\end{subfigure}%
}\caption{IPVI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_EVI_2013}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_EVI_2015}
		\caption{2015}
	\end{subfigure}%
}\\
\vfill \vspace{1mm}
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_EVI_2021}
		\caption{2021}
	\end{subfigure}
	\begin{subfigure}[b]{.55\textwidth}
		\centering
			\includegraphics[width=7.5cm]{Nigeria_EVI_2022}
		\caption{2022}
	\end{subfigure}%
}\caption{EVI computed from the Landsat 8-9 OLI/TIRS images of Niger Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig:03}
\end{figure}
